...
while 1:
    ...
    Sms: {}           {}iletisim {}instagram: batefortedancha
                                 discord: sadecesenvarsin\n  

                                 MERGEN 2026-2027 SOCİAL DEVELOPMENT
    ...
    if menu == 1:
        ...
        system("cls||clear")
        try:
            print(Fore.LIGHTYELLOW_EX + "Mail adresi (yazarsanız sms yollamak daha başarılı olur, yazmak istemiyorsanız enter basın): "+ Fore.LIGHTGREEN_EX, end="")
            mail = input()
            if ("@" not in mail or ".com" not in mail) and mail != "":
                raise
        except:
